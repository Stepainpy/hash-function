...
int main(void) {
    ...
    test_function(
        sha3_256, SHA3_256_HASH_BYTE, 43,
        /* M */ "The quick brown fox jumps over the lazy dog",
    ...
    test_function(
        sha3_384, SHA3_384_HASH_BYTE, 43,
        /* M */ "The quick brown fox jumps over the lazy dog",
    ...
    test_function(
        sha3_512, SHA3_512_HASH_BYTE, 43,
        /* M */ "The quick brown fox jumps over the lazy dog",
